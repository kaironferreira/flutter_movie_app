...
class Movies {
  ...
  @override
  String toString() {
    return 'Movies(posterPath: $posterPath, id: $id, backdropPath: $backdropPath, totalResults: $totalResults, public: $public, revenue: $revenue, page: $page, listMovies: $listMovies, iso_639_1: $iso_639_1, totalPages: $totalPages, description: $description, createdBy: $createdBy, iso_3166_1: $iso_3166_1, averageRating: $averageRating, runtime: $runtime, name: $name)';
  }
}
